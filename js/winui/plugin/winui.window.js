...
/*********** lightbox S ********************/
		...
		function lightbox(parObj){
			...
			//遮盖select
			this.Lay.innerHTML = '<iframe style="position:absolute;top:0;left:0;width:100%;height:100%;filter:alpha(opacity=0);" src="/yyexamjs/blank.html"></iframe>';

...
winui.onDOMContentLoaded(function(){
	...
	WINUI_MENUBAR_LEVEL1_DEFAULT_STYLE = "height:14px;border:1px solid #D4D0C8;/*float:left;*/padding:1px 5px 1px 5px;text-align:center;vertical-align:middle;";
	WINUI_MENUBAR_LEVEL1_ONMOUSEOVER_STYLE = "height:14px;/*float:left;*/border-top:1px solid #FFFFFF;border-left:1px solid #FFFFFF;border-right:1px solid #808080;border-bottom:1px solid #808080;padding:1px 5px 1px 5px;text-align:center;vertical-align:middle;";
	WINUI_MENUBAR_LEVEL1_ONMOUSEDOWN_STYLE = "height:14px;/*float:left;*/border-top:1px solid #808080;border-left:1px solid #808080;border-right:1px solid #FFFFFF;border-bottom:1px solid #FFFFFF;padding:2px 4px 0px 6px;text-align:center;vertical-align:middle;";
	...
	WINUI_MENUBAR_MENUTABLE_STYLE = "z-index:999999;border:2px;border-style:outset;border-color:#eee;padding:0px;padding-bottom:1px;margin:0px;width:100px;position:absolute;background-color:#D4D0C8;display:none;";		//默认样式
	WINUI_MENUBAR_MENUITEM_DEFAULT_STYLE = "color:#000;background-color:#D4D0C8;width:82px;height:18px;line-height:18px;text-align:left;padding-left:17px;overflow:hidden;";	//一级以下菜单项默认样式
	WINUI_MENUBAR_MENUITEM_MOUSEOVER_STYLE = "color:#fff;background-color:#0A246A;width:82px;height:18px;line-height:18px;text-align:left;padding-left:17px;overflow:hidden;";	//当鼠标移动至菜单后样式
	...
	for(var i=0;i<ml.length;i++){
		...
		//得到该menubar的所有div子节点
		var hrs = ml[i].getElementsByTagName("hr");//childNodes;
		
		//遍历菜单项设置<hr>样式
		for(var k=0;k<hrs.length;k++){
			hrs[k].style.margin = "3px 0px 3px 0px";
		}

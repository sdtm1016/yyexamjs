...
function table_zczyjl_cell_click(cell){
	...
	if(cell.getElementsByTagName("input").length==0){
		...
		if(cell.cellIndex==1){
			...
			cell.innerHTML="<input type='button' value='使用部门' onclick='window.parent.openWindow(\"fa_basic_ref_dr\",\"fa_card_entry\");tagid=\"\";tagname=\"zjdept\";' style='width:"+inputWidth+"px;position:absolute;margin-top:-20px;'/><input type='text' id='zjdept' style='width:"+inputWidth+"px;height:13px;' value='"+cell.innerHTML+"'/>";

...
function queryButtonClick(btn){
	...
	//部门选择
		...
		window.parent.openWindow('basic_comref_dptref','ap_qtyfd_apvouch',param);
	}
	//供应商或者客户
	else if (queryid=="CDWCODE") {
		param.subjectBusinessId = "";
		param.subjectBusinessName = "";
		window.parent.openWindow(dwrefurl,'ap_qtyfd_apvouch',param);
	}
	//结算科目
	else if (queryid=="CCODE") {
		param.subjectBusinessId = "";
		param.subjectBusinessName = "";
		window.parent.openWindow('dsign_subjectsreference','ap_qtyfd_apvouch',param);
	}
	...
	//业务员
		...
		window.parent.openWindow('basic_comref_personref','ap_qtyfd_apvouch',param);
	}
	//付款条件
	else if (queryid=="CPAYCODE") {
		param.subjecPersonId = "";
		param.subjecPersonName = "";
		window.parent.openWindow('basic_comref_payCondref','ap_qtyfd_apvouch',param);
	}
	//币种
	else if (queryid=="CEXCH_NAME") {
		param.subjecPersonId = "";
		param.subjecPersonName = "";
		window.parent.openWindow('basic_comref_exchref','ap_qtyfd_apvouch',param);
	}
